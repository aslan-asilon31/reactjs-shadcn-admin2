import useProductStore from '@/stores/brandStore';
...
const ProductFilter = ({ searchProduct, setSearchProduct, createdBy, setCreatedBy }) => {

  const { fetchAdvanceSearch,setSelectedProductId  } = useProductStore() as { products: Product; error: string | null };
